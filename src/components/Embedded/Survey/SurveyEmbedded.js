...
export class SurveyEmbeddedBare extends React.Component {
    ...
    getAnswerOptionsMultipleChoiceHTML = () => {
        return (
            this.state.answerOptions.map(answerOption => (
                <FormControlLabel
                    control={<Checkbox checked={this.state.checkboxesStatus[answerOption.value]}
                                       onChange={this.handleCheckboxChange} name={answerOption.value}/>}
                                    ...
                                    <div style={{width: "700px", height: "100%", alignContent: "flex-start"}} id="left">
                                        <Paper style={{height: "100%", width: "100%", position: "relative"}}
                                            ...
                                            <Typography variant="h6" component="h2"
                                                        style={{fontWeight: "bold", padding: "15px 0px 0px 15px"}}>
                                                {this.state.surveyQuestion}
                                            </Typography>
                                            {!this.state.surveyMultiSelect &&
                                            <div>
                                                <RadioGroup aria-label="gender" name="gender1"
                                                            value={this.state.rbValue}
                                            ...
                                            <div>
                                                <FormControl component="fieldset">
                                                    <FormLabel component="legend" style={{padding: "0 0 0 15px"}}>Answers
                                                        may be scrollable</FormLabel>
                                                    <div style={{
                                                        width: "70%",
                                                        height: "150px",
                                                        overflow: "scroll",
                                            ...
                                            >SEND</Button>
                                            {this.state.loading && <CircularProgress size={26} style={{
                                                position: "absolute",
                                                top: "20px",
                                                right: "42px"
                                            }}/>}
                                        ...
                                        <div id="right bottom" style={{height: "40%", minHeight: "95px"}}>
                                            <Paper square={true} style={{height: "100%"}}>
                                                <div style={{
                                                    ...
                                                    <IconButton onClick={this.handleSurveyDescriptionButton}
