...
import {AppBar, Toolbar, Typography, IconButton, Button, Tabs, Tab} from "@material-ui/core";
...
*/
        <React.Fragment>
            <AppBar position="static">
                <img src={"./assets/Main-JavaWizards.png"} style={{maxWidth: "150px", maxHeight: "70px", display: "inline", marginBottom: "-60px", marginLeft: "20px", marginTop: "20px"}}/>
